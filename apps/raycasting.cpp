...
class RaycastingApp: public Application {
public:
    ShaderProgram * raycastingShader;
    ShaderProgram * positionShader;

    FrameBuffer* backfaceFbo;
    FrameBuffer* frontfaceFbo;
    Mesh * fullPlane;
    QSize res;

    RaycastingApp(int argc, char *argv[]) : Application(argc,argv) {
    }
    ...
    Texture* createVolumeTexture(unsigned size) {
