...
*/
		...
		SceneGraph::Instance().addNode(new Node("Radio",{0,-2,-5}, 3, MeshFactory::Instance().loadAssimp("monkey.blend"),sphereMap));
		//SceneGraph::Instance().addNode(new Node("Radio",{0,2,-5}, 1, MeshFactory::Instance().loadAssimp("cube.obj"),phun));
		SceneGraph::Instance().addNode(new Node("Radio",{0,-7,0}, 10, MeshFactory::Instance().loadAssimp("plane.blend"),bump));
		SceneGraph::Instance().addNode(new Node("Radio",{-5,-5,-5}, .5, MeshFactory::Instance().loadAssimp("radio.obj"),green));
		//
