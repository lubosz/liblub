...
#include <math.h>
	...
	ColorTexture::ColorTexture(GLuint width, GLuint height, string name, GLenum glId){
		this->name = name;
		this->glId = glId;
		textureType = GL_TEXTURE_2D;
	...
	*/
	inline float SplatTexture::evalHermite(float pA, float pB, float vA, float vB, float u)
	{
